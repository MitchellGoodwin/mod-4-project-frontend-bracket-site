    ...
    render(){
        ...
        return(
            <Table inverted selectable striped celled>
                ...
                <Table.Body>
                    {this.props.entrants.map(entrant => <Entrant status={this.props.status} handleDeleteEntry={this.props.handleDeleteEntry} user={this.props.user} entrant={entrant} key={entrant.id} seedRange={seedRange} handleSeedChange={this.props.handleSeedChange}/>)}
                </Table.Body>
